...
class KMLExtractor:
    ...
    def create_kml_document(self, airspace: Dict, volumes: List[Dict]) -> str:
        ...
        # Styles pour les différentes parties du volume
        ...
        wall_line_color.text = 'ffff0000'  # Bleu en ABGR (format KML: AABBGGRR)
        ...
        wall_poly_color.text = '40ff0000'  # Bleu avec 25% d'opacité (0x40 = 64 = 25% de 255)
        ...
        fc_line_color.text = 'ffff0000'  # Bleu
        ...
        fc_poly_color.text = '60ff0000'  # Bleu avec opacité légèrement plus forte pour plancher/plafond
